...
*Updated again: Phase 55 is now done (see below - real ACPI shutdown,
closing the "real shutdown, not just reboot" row in 1.3), on top of
Phase 54 (a structured, minidump-inspired crash dump, closing the
"tells you why when it fails" row in 1.3), Phase 53 (a journaled
FAT32, closing the "won't corrupt data" row in 1.3), and the 50-52
