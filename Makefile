...
$(KERNEL_RUST_OBJ): kernel/rust/lib.rs kernel/rust/pipe.rs kernel/rust/spinlock.rs kernel/rust/virtio_blk.rs kernel/rust/net_irq.rs kernel/rust/acpi.rs $(RUST_CORE_RLIB) $(RUST_COMPILER_BUILTINS_RLIB)
	@mkdir -p $(dir $@)
